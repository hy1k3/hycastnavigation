...
inline uint32_t duRGBA(int r, int g, int b, int a)
{
	return ((uint32_t)r) | ((uint32_t)g << 8) | ((uint32_t)b << 16) | ((uint32_t)a << 24);
}

inline uint32_t duRGBAf(float fr, float fg, float fb, float fa)
{
	uint8_t r = (uint8_t)(fr*255.0f);
	uint8_t g = (uint8_t)(fg*255.0f);
	uint8_t b = (uint8_t)(fb*255.0f);
	uint8_t a = (uint8_t)(fa*255.0f);
...
inline uint32_t duDarkenCol(uint32_t col)
{
	return ((col >> 1) & 0x007f7f7f) | (col & 0xff000000);
}

inline uint32_t duLerpCol(uint32_t ca, uint32_t cb, uint32_t u)
{
...
inline uint32_t duTransCol(uint32_t c, uint32_t a)
{
